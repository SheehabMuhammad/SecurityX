...
namespace USBClassLibraryDemo
{
    public partial class Main : Form
    {
        public Main()
        {
            ...
            //Send data to API
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create("https://www.securityx.sheehab.me/hosts/device/new");
            request.Method = "POST";
            string formContent = "device_id: " + MyDevicePID +
                            " &type: " + DeviceTypeLabel + " &token: " + "lQQjjb2LwnS909iF3Uz1TTFvaS4rwS0m9hn43jB0zkZQ7IAJMd3YAZBFYc09" + " &name: " + FriendlyNameLabel;
